...
public class Walec extends Punkt{
    ...
    public Walec(int masa1, int promien1){ //konstruktor z parametrem
        ...
        if (promien1>0){
            ...
            System.out.println("Promien musi być większy od zera!");
        }  
    }
    
    @Override
    public int momInertia(){//obliczenie momentu bezwładności, przeciążenie metody
        return (int)(0.5*(double)(this.masa*this.promien*this.promien));
    }
    
    @Override
    public void Descript(){//wyświetlenie opisu, przeciążenie metody
         System.out.println("Nowy walec");
     }
}
